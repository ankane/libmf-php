    ...
    public static function instance()
    {
        if (!isset(self::$instance)) {
            self::$instance = \FFI::cdef('
                ...
                mf_double calc_rmse(struct mf_problem *prob, struct mf_model *model);

                mf_double calc_mae(struct mf_problem *prob, struct mf_model *model);

                mf_double calc_gkl(struct mf_problem *prob, struct mf_model *model);

                mf_double calc_logloss(struct mf_problem *prob, struct mf_model *model);

                mf_double calc_accuracy(struct mf_problem *prob, struct mf_model *model);
